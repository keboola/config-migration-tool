...
class ExGoogleAnalyticsTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return '{"Users":{"metrics":["users","users"],"dimensions":["sourceMedium","sourceMedium"]},"OrganicTraffic":{"name":"OrganicTraffic","metrics":["users","sessions"],"dimensions":["date","segment"],"filters":["ga:timeOnPage>10"],"segment":"gaid::-5"}}';
    }
}
